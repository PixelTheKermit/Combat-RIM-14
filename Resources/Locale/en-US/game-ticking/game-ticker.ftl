...
-game-ticker-get-info-preround-text = Hi and welcome to [color=white]Combat Rim 14![/color]
-                            The current round is: [color=white]#{$roundId}[/color]
...
+ game-ticker-get-info-preround-text = Hi and welcome to [color=white]Combat Rim![/color]
...
latejoin-arrival-announcement = {$character} ({$job}) has awoken from cryosleep.
